 ...
 */
class Gercpay extends PaymentModule
{
    /**
     * @var string[]
     */
    private $settingsList = [
        'GERCPAY_MERCHANT',
        'GERCPAY_SECRET_KEY',
        'GERCPAY_APPROVE_ORDER_STATUS',
        'GERCPAY_APPROVE_DECLINE_STATUS',
        'GERCPAY_APPROVE_REFUNDED_STATUS',
        'GERCPAY_LANGUAGE',
    ];
    ...
    public function __construct()
    {
        ...
        $this->bootstrap = true;
        parent::__construct();
        $this->displayName      = $this->l('GercPay Payment Gateway');
    ...
    {
        return trim(Configuration::get('GERCPAY_' . Tools::strtoupper($name)));
    }
                  ...
                  <div class="form-wrapper">
                    <div class="form-group">
                      ...
                      <div class="col-lg-3">
                        ...
                        <p class="help-block">' . $this->l('Given to Merchant by GercPay') . '</p>
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-3">
                        ...
                        <p class="help-block">' . $this->l('GercPay payment page language') . '</p>
                      </div>
                    </div>
                  </div>
    ...
    private function _displayGercPay()
    {
        $this->_html .=
            '<div style="display: flex; align-content: center; margin-bottom: 10px;">' .
                '<img src="../modules/gercpay/views/img/gercpay.png" style="margin: auto 15px auto 0; max-width: 100%; height: auto; display: block">' .
                '<div style="margin: auto 0; font-weight: bold">' . $this->l('This module allows you to accept payments by GercPay.') . '</div>' .
            '</div>';
    }
    ...
    {
        if (Tools::isSubmit('btnSubmit')) {
            Configuration::updateValue('GERCPAY_MERCHANT', Tools::getValue('merchant'));
            Configuration::updateValue('GERCPAY_SECRET_KEY', Tools::getValue('secret_key'));
            Configuration::updateValue('GERCPAY_APPROVE_ORDER_STATUS', Tools::getValue('approve_order_status'));
            Configuration::updateValue('GERCPAY_DECLINE_ORDER_STATUS', Tools::getValue('decline_order_status'));
            Configuration::updateValue('GERCPAY_REFUNDED_ORDER_STATUS', Tools::getValue('refunded_order_status'));
            Configuration::updateValue('GERCPAY_LANGUAGE', Tools::getValue('language'));
        }
        $this->_html .=
    ...
    public function getExternalPaymentOption()
    {
        ...
        $externalOption->setCallToActionText($this->l('Payment Visa, Mastercard, Google Pay, Apple Pay'))
            ->setAction($this->context->link->getModuleLink($this->name, 'redirect', [], true))
            ->setAdditionalInformation(
                $this->context->smarty->fetch('module:gercpay/views/templates/front/gercpay.tpl')
            )
            ->setLogo(Media::getMediaPath(_PS_MODULE_DIR_ . $this->name . '/views/img/gercpay.png'));
